...
public class HomeView2 extends CssLayout implements View {
	...
	private void buildUI() {
		...
		gridWrapper.setContent(grid);
		mainLayout.addComponents(banner, userActionsBar, gridWrapper);
		mainLayout.setExpandRatio(banner, 7);
		mainLayout.setExpandRatio(userActionsBar, 1);
		mainLayout.setExpandRatio(gridWrapper, 7);
